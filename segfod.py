...
#%%
RPI_IM_DIR = './data/fod_dataset/original/19dez_rpi_fod'
RPI_MASK_DIR = './data/fod_dataset/seg_maps/19dez_rpi_fod'

TX2_IM_DIR = './data/fod_dataset/original/19dez_tx2_fod'
TX2_MASK_DIR = './data/fod_dataset/seg_maps/19dez_tx2_fod'

MODEL_OUTPUT_DIR = "./artifacts"

DEVICE = 'cuda'

for path in (RPI_IM_DIR, RPI_MASK_DIR, TX2_IM_DIR, TX2_MASK_DIR, MODEL_OUTPUT_DIR):
...
def grid_search():
    config_gen = gridsearch.get_grid_search_generator()
